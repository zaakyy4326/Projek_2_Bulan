-- SCRIPT RE-SEED 55 PERFECT DESSERT PRODUCTS WITH AUTHENTIC CULINARY WIKIMEDIA ASSETS
...
INSERT INTO [dbo].[ShopProducts] ([CategoryId], [Name], [Slug], [ShortDescription], [FullDescription], [Price], [OriginalPrice], [ImageUrl], [Rating], [TotalReviews], [TotalSold], [Stock], [BadgeText], [IsFeatured], [IsActive])
VALUES (4, N'Mango Sago Coconut Panna Cotta Cup', N'mango-sago-coconut-panna-cotta', N'Panna cotta lembut berpadu puree mangga harum dan sagu mutiara kenyal menyegarkan.', N'Dessert cup dingin berlapis panna cotta krim kelapa gurih dan buah mangga manis alami.', 36000, NULL, N'', 4.8, 59, 160, 35, NULL, 0, 1);
GO
...
INSERT INTO [dbo].[ShopProducts] ([CategoryId], [Name], [Slug], [ShortDescription], [FullDescription], [Price], [OriginalPrice], [ImageUrl], [Rating], [TotalReviews], [TotalSold], [Stock], [BadgeText], [IsFeatured], [IsActive])
VALUES (5, N'Wild Strawberry & Cream Gelato Pint (473ml)', N'wild-strawberry-cream-gelato', N'Gelato stroberi segar dengan swirl selai stroberi alami berwarna pink cerah.', N'Dibuat dari stroberi segar asli dengan paduan krim susu lembut yang memanjakan lidah.', 85000, NULL, N'', 4.8, 63, 180, 25, NULL, 0, 1);
GO
